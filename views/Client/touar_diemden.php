        ...
        <div class="content service-package">
            ...
            <div class="service-package_1">
                <div>
                    ...
                    <h2 class="service-package_1_2-content-text ">Gói du lịch tốt nhất</h2>
            ...
            <div class="service-package_2-link">
                <a a href="<?= BASE_URL ?>?page=blog" class="service-package_2-link">Đọc Thêm </a>
            </div>
            <script src="<?= Js_Client ?>CasOptionTouar.js"></script>
        </div>
    </section>
</body>
