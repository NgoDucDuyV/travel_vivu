        ...
        <div class="content-container">
            <div class="header-section">
                <div class="title-section">
                    ...
                    <span class="item-count">
                        <?php echo count($datauserAdmin); ?>
                    </span>
                </div>
                <div class="action-buttons">
                    <a href="<?= BASE_URL ?>?mode=admin&act=NhanVienMoi">
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        <?php foreach ($datauserAdmin as $key => $value) { ?>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="<?= BASE_URL ?>?mode=admin&act=ShowDetailsNhanVien&id=<?= $value->id ?>" class="dropdown-item show-action">
                                                    <i class="fa-solid fa-desktop"></i>
                                                    <span>Show</span>
                                                </a>
                                                <a href="<?= BASE_URL ?>?mode=admin&act=EditUserNhanVien&id=<?= $value->id ?>" class="dropdown-item edit-action">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                    <span>Edit</span> </a>
                                                <a href="<?= BASE_URL ?>?mode=admin&act=DeleteUSserNhanVien&id=<?= $value->id ?>" class="dropdown-item delete-action">
