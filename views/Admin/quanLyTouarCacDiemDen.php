...
<head>
    ...
    <link rel="stylesheet" href="<?= CssAdmin ?>quanlyDiemDen.css">
            ...
            <div class="header-section">
                <div class="title-section">
                    ...
                    <span class="item-count">
                        <?php echo count($dataDestination); ?>
                    </span>
                </div>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>ID</th>
                            <th>Tên Điểm Đến </th>
                            <th>Số Lượng Touar </th>
                            <th>Ngày Khởi Tạo </th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($dataDestination as $key => $value) { ?>
                            <a href="#">
                                <tr>
                                    ...
                                    <td><?= $value->title ?></td>
                                    <td><?= $value->soluong_tuar  ?></td>
                                    <td> </td>
                                    <td>
                                        <div class="dropdown">
                                            <i class="fa-solid fa-ellipsis dropdown-toggle"></i>
                                            <div class="dropdown-menu">
                                                <a href="#" class="dropdown-item show-action">
                                                    <i class="fa-solid fa-desktop"></i>
                                                    <span>Show</span>
                                                </a>
                                                <a href="<?= BASE_URL ?>?mode=admin&act=editTuar" class="dropdown-item edit-action">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                    <span>Edit</span>
                                                </a>
                                                <a href="#" class="dropdown-item delete-action">
