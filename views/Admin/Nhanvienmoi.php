...
<body>
    <?php if (isset($_SESSION['errorInserNhanVienMoi'])): ?>
        <div class="errorInsertTouar"><?= $_SESSION['errorInserNhanVienMoi'] ?></div>
    <?php endif ?>
    ...
    <div class="contentAdmin">
        ...
        <form action="<?= BASE_URL ?>?mode=admin&act=NhanVienMoi" method="post">
            <div class="form-group">
                <label for="Destination">fullname Tên Hiển Thị </label>
                <input type="text" id="fullname" name="fullname" class="form-control form-group" placeholder="Nhập Đầy đủ tên hiển thị ">
            </div>

            <div class="form-group">
                <label for="Destination">sdt Số Điện Thoại </label>
                <input type="number" id="sdt" name="sdt" class="form-control form-group" placeholder="Nhập Số Điện Thoại ">
            </div>

            <div class="form-group">
                <label for="Destination">useremail Email Đăng Nhập </label>
                <input type="email" id="useremail" name="useremail" class="form-control form-group" placeholder="Nhập Email đăng nhập ">
            </div>

            <div class="form-group">
                <label for="Destination">password Mật Khẩu Đăng Nhập </label>
                <input type="text" id="password" name="password" class="form-control form-group" placeholder="Nhập Pasword đăng nhập ">
            </div>
